...
class ScholarshipAgent:
    ...
    async def process(self, scholarship_data: dict | None, user_question: str) -> str:
        """处理奖助学金查询请求。

        Args:
            scholarship_data: campus-service 返回的奖助数据（字典或 None）
        ...
        try:
            ...
            logger.info(f"ScholarshipAgent 处理完成, 问题: {user_question[:50]}...")
            return result
