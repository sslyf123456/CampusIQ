...
- start_period / end_period: 第几节课（如 start_period=1, end_period=2 表示第1-2节）
- start_week / end_week: 起止周次
- 不要编造具体的时钟时间（如08:00-09:40），数据中没有时间信息，只用"第X-Y节"描述
...
回答时请按星期和节次顺序整理课程信息，包括课程名称、节次、教室、教师等。
